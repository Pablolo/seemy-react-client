            ...
            {match && (
              <div>
                ...
                <form onSubmit={this.handleSubmit}>
                  ...
                  <input type="text" name="city" id="city" defaultValue={car.city} onChange={this.handleChange} />
                  ...
                  <input type="text" name="make" id="make" defaultValue={car.make} onChange={this.handleChange} />
                  <label htmlFor="model">Model</label>
                  <input type="text" name="model" id="model" defaultValue={car.model} onChange={this.handleChange} />
                  <label htmlFor="year">Year</label>
                  <input type="number" name="year" id="year" defaultValue={car.year} onChange={this.handleChange} />
                  ...
                  <input type="text" name="image" id="image" defaultValue={car.image} onChange={this.handleChange} />
