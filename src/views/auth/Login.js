      ...
      <div className="absolute mt-20 w-screen text-center bg-gray-200">
        <div className="w-5/6 my-8 bg-white shadow-md rounded px-8 pt-6 pb-8 my-0 mx-auto">
          ...
          <form className="flex flex-col text-center" onSubmit={this.handleSubmit}>
            ...
            />
            {errors.email && (
              <div className="text-red-500 text-sm italic w-11/12 text-left mx-auto">Email field cannot be empty</div>
            )}
            <label className="block text-gray-700 font-bold mb-2 text-left w-11/12 mt-2 mx-auto" htmlFor="password">
              Password
            </label>
            <input
              className="shadow appearance-none border rounded my-0 mx-auto w-11/12 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
            ...
            />
            {errors.password && (
              <div className="text-red-500 text-sm italic w-11/12 text-left mx-auto">Password cannot be empty</div>
            )}
            {!errors.password && !errors.email && error && (
              <div className="text-red-500 text-sm italic mt-3">{error}</div>
            )}
            <div className="mx-auto w-11/12 justify-between flex items-center my-8">
              <input
